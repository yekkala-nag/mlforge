declare const PRESET_BASES: readonly ["radix", "base", "aria"];
type PresetBase = (typeof PRESET_BASES)[number];
declare function isPresetBase(value: unknown): value is PresetBase;
...
export { DEFAULT_PRESET_CONFIG, PRESET_BASES, PRESET_BASE_COLORS, PRESET_CHART_COLORS, PRESET_FONTS, PRESET_FONT_HEADINGS, PRESET_ICON_LIBRARIES, PRESET_MENU_ACCENTS, PRESET_MENU_COLORS, PRESET_RADII, PRESET_STYLES, PRESET_THEMES, type PresetBase, type PresetConfig, V1_CHART_COLOR_MAP, decodePreset, encodePreset, fromBase62, generateRandomConfig, generateRandomPreset, isPresetBase, isPresetCode, isValidPreset, toBase62 };
